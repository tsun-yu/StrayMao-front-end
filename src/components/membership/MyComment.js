...
<div className="myCommentWrap">
    <div className="productMain">
        ...
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="svg-inline--fa fa-star fa-w-18 solidStar" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"></path></svg>
    ...
    <div className="commentMain">
        <div className="productName">商品名稱：：鮮肉煲罐頭</div>
        <div className="commentContent">商品不錯！家中寶貝很喜歡~</div>
        <div className="commentDate">評價日期：2020-09-22</div>
    </div>
    
    <div className="commentBtnGroup">
        <button className="commentBtn">編輯</button>
        <button className="commentBtn">刪除</button>
        <button className="commentBtn">儲存</button>
    </div>
</div>
...
<div className="myCommentWrap">
    <div className="productMain">
        <img className="productImg" src="./image/membership/brothcan-1-510x510.jpg" alt="product image" />
        <div className="commentStar">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="svg-inline--fa fa-star fa-w-18 solidStar" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"></path></svg>
