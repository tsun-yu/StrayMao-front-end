    ...
    <>
      <div className="page3single ">
        <div className="page3topic text-center">
          <div className="page3big ">性別</div>
          <div className="page3small">一步一步，　找到愛帶回家。</div>
          {/* <div>{state}</div> */}
          <div className="d-flex justify-content-center">
            <div className="page3circle ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="90.249"
                height="164.596"
                viewBox="0 0 90.249 164.596"
              >
                <g
                  id="Group_616"
                  data-name="Group 616"
                  transform="translate(-3333 -2239.404)"
                >
                  <g
                    id="Ellipse_14"
                  ...
                  <path
                    id="Path_1287"
                    data-name="Path 1287"
                    d="M3421.8,2299.146l-43.3-30.646-40.64,30.646"
