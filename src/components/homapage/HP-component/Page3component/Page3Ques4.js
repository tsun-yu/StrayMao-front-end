...
function Page3Ques4(props) {
  ...
  const maleColorToggle = () => {
    const maleSvg = document.querySelector(
      '#root > main > div > div:nth-child(4) > div > div > div:nth-child(4) > div.d-flex.justify-content-center.align-items-center > a.mr-5'
    ).classList
  ...
  const femaleColorToggle = () => {
    const femaleSvg = document.querySelector(
      '#root > main > div > div:nth-child(4) > div > div > div:nth-child(4) > div.d-flex.justify-content-center.align-items-center > a.ml-5'
    ).classList
