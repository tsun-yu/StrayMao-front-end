...
<<<<<<< HEAD:src/components/cart/cartlistCardC.js
    ...
    <>
      <div class="cartlistC_boxUpper_An d-flex">
        ...
        <div class="cartlistC_demo_An">
          <input
            class="cartlistC_magic-checkbox_An"
            type="checkbox"
            name="layout"
            id="c1"
          />
        ...
        <img
          class="cartlistC_goodsImg_An"
          src="./image/store/brothcan-1-510x510.jpg"
        ></img>
        <span class="cartlistC_goodsName_An">
          Farmina 法米納獸醫寵愛天然配方-貓用腸胃道 5kg
        </span>
        <div class="cartlistC_inputbox_An d-flex">
          ...
          <input
            class="cartlistC_input-black_An"
            type="text"
            placeholder="123"
            value="1"
          />
...
<>
    <div className="cartlistC_boxUpper_An d-flex">
        ...
        <div className="cartlistC_demo_An">    
            <input className="cartlistC_magic-checkbox_An" type="checkbox" name="layout" id="c1"/>
            <label for="c1"></label>
        </div>
        <img className="cartlistC_goodsImg_An" src="./image/store/brothcan-1-510x510.jpg"></img>
        <span className="cartlistC_goodsName_An">{props.info.name}Farmina 法米納獸醫寵愛天然配方-貓用腸胃道 5kg</span>
        <div className="cartlistC_inputbox_An d-flex">
            ...
            <input className="cartlistC_input-black_An" type="text" placeholder="123" value="1"/>
...
>>>>>>> 6264cc9997f0a3182b1f9b7767d88642000ac679:src/components/cart/CartListCardC.js
