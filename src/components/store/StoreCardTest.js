...
import '../../styles/store/storeCard.scss'
import { connect } from 'react-redux'

function StoreCardTest(props) {
      ...
      <div className="box">
        <div className="cardline">
          ...
          <div className="cardtext">
            <div className="cardname">dog toy</div>
            <div className="cardlittletext">
              <div className="cardprice">200</div>
              <div className="cardpricing">300</div>
              <div className="cart">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="21.388"
...
export default connect(mapStateToProps, {})(StoreCardTest)
